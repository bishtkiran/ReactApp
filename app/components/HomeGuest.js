    ...
    switch (action.type) {
      ...
      case "emailUniqueResults":
        if (action.value) {
          ...
          draft.email.message = "Email already used."
        } else {
      ...
      case "passwordImmediately":
        ...
        if (draft.password.value.length > 50) {
          ...
          draft.password.message = "Password must not exceed 50 characters."
        }
        return
      case "passwordAfterDelay":
        if (draft.password.value.length < 12) {
          draft.password.hasErrors = true
          draft.password.message = "Password must be 12 characters long."
        }
        return
      case "submitForm":
